...
../bin/bbmap/reformat.sh in1=$FWD_READS in2=$REV_READS out1=${FWD_READS}.fq out2=${REV_READS}.fq addslash
snippy --mincov 5 --minfrac 0.2 --cpus 12 --outdir $OUTDIR --ref $REF_GBK --R1 ${FWD_READS}.fq --R2 ${REV_READS}.fq



snippy --help
snippy --mincov 5 --minfrac 0.2 --minqual 20

 --targets sites.bed 

REF_GB='Campylobacter_jejuni_subsp__jejuni_CG8421_GCA_000171795_2-contigs.fa'
snippy --mincov 5 --minfrac 0.2 --minqual 20 --cpus 12 --outdir $OUTDIR --ref $REF_GBK --R1 $FWD_READS --R2 $REV_READS
